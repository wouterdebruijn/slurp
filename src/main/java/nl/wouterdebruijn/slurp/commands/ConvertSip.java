...
public class ConvertSip implements TabExecutor {
    public ConvertSip() {
        Objects.requireNonNull(Slurp.getPlugin().getCommand("convertsip")).setExecutor(this);
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        try {
            ...
            if (sipCount * -1 > slurpPlayer.remaining.sips) {
                MessageController.sendMessage(player, true, ChatColor.RED + "Hold up, you don't have that many sip(s)!");
                return true;
            }
            ...
            int shotCount = (sipCount * -1) / ConfigController.getInt("shots-to-sips-multiplier");
