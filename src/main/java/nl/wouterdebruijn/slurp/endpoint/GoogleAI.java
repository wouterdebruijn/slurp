    ...
    private final static class GoogleAIRequest {
        private static final JsonObject systemInstructions = JsonParser
                .parseString("{\n" + //
                        ...
                        "        },\n" + //
                        "        {\n" + //
                        "            \"text\": \"    Add in some fun Movie, Tv, Pop or Gaming references and memes where appropriate. The audience is around 20-30 years old, so references to popular culture from the last 20 years are appropriate.\"\n"
                        + //
                        "        },\n" + //
                        "        {\n" + //
